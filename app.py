...
async def register_user(input_data: UserCreate):
    ...
    return {"message": "User added successfully", "user_email": str(user_data.email)}
...
async def update_libraries(email: str, update_data: UpdateLibraries):
    ...
    for lib in new_libraries:
        ...
        if response.status_code == 200:
            ...
            lib_versions.append(f"{lib}: {latest_version}")
            return True
    ...
    return {"message": "Libraries updated successfully", "libraries": new_libraries}
